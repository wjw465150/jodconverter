...
public class ConvertDocument {
    ...
    private static final Option OPTION_HOST = new Option("h", "host", true, "OpenOffice.org host");
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        try {
            if (verbose) {
                System.out.println("-- connecting to OpenOffice.org on host:port " + host+":"+port);
            }
            connection.connect();
        } catch (ConnectException officeNotRunning) {
            System.err.println("ERROR: connection failed. Please make sure OpenOffice.org is running and listening on host:port " + host+":"+port + ".");
